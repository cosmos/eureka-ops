...
contract DeployProxiedICS20TransferScript is DeploymentVerifier {
    ...
    function run() public returns (address){
        ...
        ERC1967Proxy transferProxy = deployProxiedICS20Transfer(deployment, accessManagerDeployment.accessManager);
        ...
        verifyICS20Transfer(deployment, accessManagerDeployment);
        ...
        vm.serializeAddress("ics20Transfer", "delegateSenders", deployment.delegateSenders);
        ...
        function deployProxiedICS20Transfer(Deployments.ProxiedICS20TransferDeployment memory deployment, address accessManager) public returns (ERC1967Proxy) {
