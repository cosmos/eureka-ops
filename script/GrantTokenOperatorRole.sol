...
contract GrantTokenOperatorRole is Script, Deployments {
    function run() public {
        ...
        address tokenOperatorAddress = vm.promptAddress("Token operator address");
        ...
        ics20Transfer.grantTokenOperatorRole(tokenOperatorAddress);
